...
Entries from v1.3.2 onwards are generated by [release-please](https://github.com/googleapis/release-please) from [Conventional Commits](https://www.conventionalcommits.org/).

## [3.0.0](https://github.com/BfArM-MVH/GRZ_QC_Workflow/compare/v2.1.0...v3.0.0) (2026-07-08)


### ⚠ BREAKING CHANGES

* require Nextflow 26.04 as the minimum supported version

### Features

* require Nextflow 26.04 as the minimum supported version ([9244b30](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/9244b30daf7cb76fa2ebde885e61e8770469df4c))
* update all nf-core modules and subworkflows ([#204](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/204)) ([9244b30](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/9244b30daf7cb76fa2ebde885e61e8770469df4c))


### Bug Fixes

* **config:** add canonical test profile alias ([#208](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/208)) ([838d341](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/838d341e54aa75aafb1411c71c38458f73440b97))

## [2.1.0](https://github.com/BfArM-MVH/GRZ_QC_Workflow/compare/v2.0.0...v2.1.0) (2026-06-15)


### Features

* **report:** add grzQcWorkflowVersion column ([#199](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/199)) ([f13e513](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/f13e513eca18cb3b1854f63f7d024cff5aa54a32))


### Bug Fixes

* **deps:** bump grz-pydantic-models to 2.7.1 ([#200](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/200)) ([515d9b3](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/515d9b36b451894ade416f0f0e71dd7134c86a79))
* **merge-reports:** create report_mqc.csv in stub block ([6e698ea](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/6e698ea4b8fdde1a74f6a1aec79fa9e2a0e0a1cd))
* **multiqc:** split GRZ QC dedup/redundant report sections ([#202](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/202)) ([6e698ea](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/6e698ea4b8fdde1a74f6a1aec79fa9e2a0e0a1cd))

## [2.0.0](https://github.com/BfArM-MVH/GRZ_QC_Workflow/compare/v1.3.2...v2.0.0) (2026-05-27)


### ⚠ BREAKING CHANGES

* `report.csv` now points to the deduplicated (nonredundant) merge output instead of the redundant one. Downstream tooling expecting duplicate rows in `report.csv` must read `redundant_report.csv` directly.

### Features

* switch report.csv to deduplicated output ([#197](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/197)) ([c6f901c](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/c6f901c0c6ac10d7860b53089a74cdba9069bc29))

## [1.3.2](https://github.com/BfArM-MVH/GRZ_QC_Workflow/compare/v1.3.1...v1.3.2) (2026-05-27)


### Bug Fixes

* bed parsing skips headers and validates critical columns ([#188](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/188)) ([#194](https://github.com/BfArM-MVH/GRZ_QC_Workflow/issues/194)) ([d2b9fff](https://github.com/BfArM-MVH/GRZ_QC_Workflow/commit/d2b9fffb88acb64ed1f01ef6619b0dba8d55fd19))
