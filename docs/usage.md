...
| `meanDepthOfCoverage`               | **yes**                        | Mean depth of coverage across target regions (panel/WES) or genome-wide (WGS).                                                                           |
| `targetedRegionsAboveMinCoverage`   | **yes**                        | Fraction (between 0 and 1) of target regions with coverage above the minimum required for the library type.                                              |
| `percentBasesAboveQualityThreshold` | **yes**                        | Percentage (between 0 and 100) of **untrimmed** read bases that are above the minimum quality threshold for the library type.                            |
