...
| `grzQcWorkflowVersion`                       | Version of the GRZ QC workflow used to produce this report, suffixed with `+nonredundant` or `+redundant` depending on whether reads were deduplicated.                                                                                                                                                            |
<!-- prettier-ignore-end -->
